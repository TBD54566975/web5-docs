...
public final class SanctionsCredential {
    ...
    private final java.util.List<java.lang.String> listsCleared = null;
    
    public SanctionsCredential(@org.jetbrains.annotations.NotNull()
    java.util.List<java.lang.String> listsCleared) {
        super();
    }
    
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<java.lang.String> getListsCleared() {
        return null;
    }
