...
This code snippet queries for records with a plain text data format, and returns them in ascending order by the date they were [published](/web5/decentralized-web-nodes/publishing-records):
