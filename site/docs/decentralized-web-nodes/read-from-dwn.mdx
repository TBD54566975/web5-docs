...
However, you may not have the `recordId` available, and instead need to query for records that match a [specific filter](/web5/decentralized-web-nodes/query-from-dwn#filterable-record-properties). This will return an array of records:
