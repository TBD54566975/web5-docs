...
In this guide, we'll cover the process of presenting [Verifiable Credentials (VCs)](/web5/verifiable-credentials/what-are-vcs) to a verifier.
...
:::note
Before presenting VCs in a PEX, it's important to note that the VCs would have already been [created](/web5/verifiable-credentials/vc-issuance#create-vc),
[signed in a JWT format](/web5/verifiable-credentials/vc-issuance#sign-vc), and [stored](/web5/verifiable-credentials/vcs-in-dwn#storing-vc-in-dwn)
in the user's Wallet application.
:::

## Presentation Definition

The entity requesting credentials, aka the verifier, will have defined the presentation requirements using a [Presentation Definition](/web5/verifiable-credentials/presentation-definition).
...
Once the [Presentation](/glossary#verifiable-presentation) is error-free and has passed the validation checks, you can submit the Verifiable Presentation as a signed and encoded JWT to the lender for [verification](/web5/verifiable-credentials/verify-vc#verify-verifiable-presentations).
