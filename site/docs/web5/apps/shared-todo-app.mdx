...
In the [Build a Todo App](/web5/apps/todo-app-tutorial) tutorial, we learned how to build a single-user decentralized todo app with `Web5.js` and `Vue.js`.
...
- Enforce permissions or authorization on records through [protocols](/web5/decentralized-web-nodes/what-are-protocols)
- Send and update records across multiple users' [Decentralized Web Nodes (DWN)](/web5/decentralized-web-nodes/what-are-dwns)
...
[Protocols](/web5/decentralized-web-nodes/what-are-protocols) help define both the data schema and permissions as it relates to a certain application or use case. It details what objects are stored as part of the application and who has what permissions on these objects.
