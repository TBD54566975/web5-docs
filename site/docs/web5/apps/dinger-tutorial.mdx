...
### 📘 Learn more
Learn more about [defining protocols](https://developer.tbd.website/web5/decentralized-web-nodes/what-are-protocols#defining-a-protocol).
...
### 📘 Learn more
Learn more about [querying protocols](https://developer.tbd.website/web5/decentralized-web-nodes/what-are-protocols#protocols-in-practice).
...
### 📘 Learn more
- Learn more about [protocols](https://developer.tbd.website/web5/decentralized-web-nodes/what-are-protocols/).
...
### 📘 Learn more
- Learn more about[ Decentralized Web Nodes](/web5/decentralized-web-nodes/what-are-dwns) and [writing DWN records](https://developer.tbd.website/web5/decentralized-web-nodes/write-to-dwn).
...
### 📘 Learn more
- Learn more about [sync intervals](https://developer.tbd.website/web5/decentralized-web-nodes/sync#sync-intervals).
...
### 📘 Learn more
- - Learn more about how to [query DWN records](/web5/decentralized-web-nodes/query-from-dwn) and [filterable record properties](/web5/decentralized-web-nodes/query-from-dwn#filterable-record-properties).
...
<a href="https://developer.tbd.website/web5/decentralized-web-nodes/sync/">Sync</a> intervals occur every two minutes. If you're eager to see immediate updates for testing purposes, you can adjust the sync settings. Update the line:
