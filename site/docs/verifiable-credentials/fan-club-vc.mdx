...
In this tutorial, we'll learn how to use [verifiable credentials](/web5/verifiable-credentials/what-are-vcs) (VC) to ensure Alice is recognized as an official member of the exclusive Swifties Fan Club.
...
As a prerequisite, both the Fan Club and Alice need [decentralized identifiers](/web5/decentralized-identifiers/what-are-dids).
...
Signing the credential returns a [VC JSON Web Token](/web5/verifiable-credentials/jwt-to-vc#what-is-a-jwt), ideal for secure transmission of the credential.
