...
>This assumes the [presentation definition](/web5/verifiable-credentials/presentation-definition#example-presentation-definition) is assigned to variable `pd`
