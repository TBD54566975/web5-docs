...
In this tutorial, you will learn how to build a basic single-party decentralized ToDo app built using `web5.js`. It’s composed of a `Vue.js` app powered by [web5.js](https://www.npmjs.com/package/@web5/api) which adds data storage underpinned by a [Decentralized Web Node](/decentralized-web-nodes/what-are-dwns) (DWN).
