...
In the [Build a Todo App](/apps/todo-app-tutorial) tutorial, we learned how to build a single-user decentralized todo app with `Web5.js` and `Vue.js`.
...
- Enforce permissions or authorization on records through [protocols](/decentralized-web-nodes/what-are-protocols)
- Send and update records across multiple users' [Decentralized Web Nodes (DWN)](/decentralized-web-nodes/what-are-dwns)
...
[Protocols](/decentralized-web-nodes/what-are-protocols) help define both the data schema and permissions as it relates to a certain application or use case. It details what objects are stored as part of the application and who has what permissions on these objects.
