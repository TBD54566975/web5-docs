...
[\<\< More on Agents \>\>](/decentralized-web-nodes/agents)

## Bearer DID

A Bearer DID is a composite type that combines a [DID](#decentralized-identifier-did), its associated [DID Document](#did-document), and a [Key Manager](/decentralized-identifiers/key-management) containing the DID's cryptographic keys. It provides methods for signing data, verifying signatures, and managing the DID's associated keys.
...
[\<\< More on DIDs \>\>](/decentralized-identifiers/what-are-dids/)
...
[\<\< More on DWNs \>\>](/decentralized-web-nodes/what-are-dwns)
...
[\<\< More on DID Documents \>\>](/decentralized-identifiers/did_documents)
...
[\<\< More on Portable DIDs \>\>](/decentralized-identifiers/how-to-create-did#portable-did)
...
[\<\< More on Verifiable Presentation \>\>](/verifiable-credentials/presentation-exchange#verifiable-presentation)
