...
[Decentralized Identifiers (DIDs)](/web5/decentralized-identifiers/what-are-dids) are how you are identified on the decentralized web.
This guide covers how to use Web5 to create a DID.

You can create a DID using any of the [Web5-supported DID methods](/web5/decentralized-identifiers/what-are-dids#methods) by using the [DID package](https://www.npmjs.com/package/@web5/dids).
...
The [DID Document](/web5/decentralized-identifiers/did_documents) is a self-contained representation of the DID and provides metadata and cryptographic material associated with the DID
