...
<ul>
  <li>
    <p><a href="https:/.npmjs.com/downloading-and-installing-node-js-and-npm" target="_blank">Node Package Manager</a>, <code>npm</code>, installed and on your system's <code>$PATH</code>.</p>
  </li>
  <li>
...
In Web5 apps, a user’s unique identifier - like an email address - is called a [Decentralized Identifier (DID)](/web5/decentralized-identifiers/what-are-dids).
...
This Web5 instance is what you'll use to access the other objects of Web5 such as `dwn`. Within the connect function we’re using `dht` as the DID method. Learn more [DID methods](/web5/decentralized-identifiers/what-are-dids#methods).
...
[Verifiable Credentials (VCs)](https://developer.tbd.website/web5/verifiable-credentials/what-are-vcs) are digital proofs used to confirm specific facts about individuals, organizations, or entities.
...
Your users can now store the JWT form of their VC in a [DWN (Decentralized Web Node)](https://developer.tbd.website/web5/decentralized-web-nodes/what-are-dwns).
...
:::note
Since the record is [public](/web5/decentralized-web-nodes/publishing-records) 
...
the [query](/web5/decentralized-web-nodes/query-from-dwn) method. 
:::
...
* [Learn more about DIDs](/web5/decentralized-identifiers/what-are-dids)
* [Learn more about VCs](/web5/verifiable-credentials/what-are-vcs)
* [Learn more about DWNs](/web5/decentralized-web-nodes/what-are-dwns)
* [Build a shared ToDo app](/web5/apps/shared-todo-app) 
